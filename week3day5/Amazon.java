...
public static void main(String[] args) throws IOException {
	...
	String rating1= oneplus.findElement(By.xpath("//span[@class='a-size-medium a-color-base a-text-beside-button a-text-bold']")).getText();
	...
	System.out.println(total);
	  ...
	  File des=new File("./screenshot/SnapShot.png");
